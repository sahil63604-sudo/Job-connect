...
const { getAllUsers, deleteUser,getAllJobs, admindeleteJob,getAdminStats } = require('../controller/adminController');
...
AdminRouter.get("/stats",authMiddleware,AdminMiddleware,getAdminStats)
